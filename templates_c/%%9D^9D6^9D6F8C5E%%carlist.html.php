...
/index.php?m=search&sb=0" class="condition"><?php echo $_COOKIE['subbrandname']; ?>
</a></li><?php endif; ?>
...
/index.php?m=search&clear=1"><i class="i-del"></i>清空全部条件</a></span>
			</div>
...
/index.php?m=search&order=<?php if ($_COOKIE['order'] == 1): ?>2<?php elseif ($_COOKIE['order'] == 2): ?>1<?php else: ?>2<?php endif; ?>" <?php if ($_COOKIE['order'] == 1): ?>class="or01"<?php elseif ($_COOKIE['order'] == 2): ?>class="or03"<?php else: ?>class="or02"<?php endif; ?>>时间</a></li>
					<li><a href="<?php echo $this->_tpl_vars['weburl']; ?>
/index.php?m=search&order=<?php if ($_COOKIE['order'] == 3): ?>4<?php elseif ($_COOKIE['order'] == 4): ?>3<?php else: ?>3<?php endif; ?>" <?php if ($_COOKIE['order'] == 3): ?>class="or01"<?php elseif ($_COOKIE['order'] == 4): ?>class="or03"<?php else: ?>class="or02"<?php endif; ?>>价格</a></li>
					<li><a href="<?php echo $this->_tpl_vars['weburl']; ?>
/index.php?m=search&order=<?php if ($_COOKIE['order'] == 5): ?>6<?php elseif ($_COOKIE['order'] == 6): ?>5<?php else: ?>5<?php endif; ?>" <?php if ($_COOKIE['order'] == 5): ?>class="or01"<?php elseif ($_COOKIE['order'] == 6): ?>class="or03"<?php else: ?>class="or02"<?php endif; ?>>里程</a></li>
					<li><a href="<?php echo $this->_tpl_vars['weburl']; ?>
/index.php?m=search&order=<?php if ($_COOKIE['order'] == 7): ?>8<?php elseif ($_COOKIE['order'] == 8): ?>7<?php else: ?>7<?php endif; ?>"  <?php if ($_COOKIE['order'] == 7): ?>class="or01"<?php elseif ($_COOKIE['order'] == 8): ?>class="or03"<?php else: ?>class="or02"<?php endif; ?>>车龄</a></li>
				</ul>
				<div class="showtype">
...
" target="_blank"><?php echo $this->_tpl_vars['cars_list']['p_shortname']; ?>
						...
						<p class="red"><span class="price">已售罄</span><span class="fr pt5 mt15"><?php if ($this->_tpl_vars['cars_list']['isdealer'] == 2): ?><span class="check01" title="商家车源"></span><?php endif; ?> <?php if ($this->_tpl_vars['cars_list']['isdealer'] == 1): ?><span class="check02" title="个人车源"></span><?php endif; ?> <?php if ($this->_tpl_vars['cars_list']['uid'] == -1): ?><span class="check05" title="本站发布"></span><?php endif; ?><?php if ($this->_tpl_vars['cars_list']['isnew_old'] == 1): ?><span class="check04" title="新车旧卖"></span><?php endif; ?><?php if ($this->_tpl_vars['cars_list']['isshow'] == 1): ?><span class="check03" title="审核通过"></span><?php else: ?><span title="待审核">待审核</span><?php endif; ?></span></p>
...
</span> <?php if ($this->_tpl_vars['cars_list']['p_price'] <> "面议"): ?>万<?php endif; ?><span class="fr pt5 mt15"><?php if ($this->_tpl_vars['cars_list']['isdealer'] == 2): ?><span class="check01" title="商家车源"></span><?php endif; ?> <?php if ($this->_tpl_vars['cars_list']['isdealer'] == 1): ?><span class="check02" title="个人车源"></span><?php endif; ?> <?php if ($this->_tpl_vars['cars_list']['uid'] == -1): ?><span class="check05" title="本站发布"></span><?php endif; ?><?php if ($this->_tpl_vars['cars_list']['isnew_old'] == 1): ?><span class="check04" title="新车旧卖"></span><?php endif; ?><?php if ($this->_tpl_vars['cars_list']['isshow'] == 1): ?><span class="check03" title="审核通过"></span><?php else: ?><span title="待审核">待审核</span><?php endif; ?></span></p>
						<p class="gray01 mt5"><span class="fr">里程：<?php echo $this->_tpl_vars['cars_list']['p_kilometre']; ?>
万公里</span>上牌:<?php echo $this->_tpl_vars['cars_list']['p_year']; ?>
年<?php echo $this->_tpl_vars['cars_list']['p_month']; ?>
月</p>
...
</a></span>&nbsp;    <span class="fl pt5"><?php if ($this->_tpl_vars['cars_list']['isdealer'] == 2): ?><span class="check01" title="商家车源"></span><?php endif; ?> <?php if ($this->_tpl_vars['cars_list']['isdealer'] == 1): ?><span class="check02" title="个人车源"></span><?php endif; ?> <?php if ($this->_tpl_vars['cars_list']['uid'] == -1): ?><span class="check05" title="本站发布"></span><?php endif; ?><?php if ($this->_tpl_vars['cars_list']['isnew_old'] == 1): ?><span class="check04" title="新车旧卖"></span><?php endif; ?><?php if ($this->_tpl_vars['cars_list']['isshow'] == 1): ?><span class="check03" title="审核通过"></span><?php else: ?><span title="待审核">待审核</span><?php endif; ?></span></p>
							<p class="gray">

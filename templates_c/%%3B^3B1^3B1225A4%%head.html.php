...
/index.php?m=city"></script></div></div>
...
/index.php?m=citylist" class="orange01">更多城市</a></p>
			</div>
			<?php endif; ?>
		<div class="topsearch">
...
/index.php?m=dealer" class="here" style="background:#53a3e8;width:130px;vertical-align:top;"><img src="<?php echo $this->_tpl_vars['weburl']; ?>
/templates/default/default/img/dealer.png"/>认证商家</a></li>
	</ul>
</div>
<!--头部end -->
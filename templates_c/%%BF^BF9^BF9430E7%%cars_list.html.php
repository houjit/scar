<?php /* Smarty version 2.6.18, created on 2016-10-31 10:17:58
...
?m=cars" method="POST" name="form" onSubmit="return listsubmitconfirm(this.form)">
	...
	<tr><th width="30">选择</th><th>ID</th><th>信息编号</th><th align="left">品牌</th><th>车型</th><th>报价</th><th>上牌日期</th><th>发布时间</th><?php if ($this->_tpl_vars['setting']['version'] == 2 || $this->_tpl_vars['setting']['version'] == 3): ?><th>会员</th><?php endif; ?><?php if ($this->_tpl_vars['setting']['version'] == 3): ?><th>城市</th><?php endif; ?><th>显示</th><th>已卖</th><th>点击</th><th width="230">操作</th></tr>

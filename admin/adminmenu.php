...
<div class="sidebar">
	...
	<ul class="hide">
		...
		<li><a href="<?php echo WEB_PATH?>?m=create_html&a=rentcars" target="report_iframe">更新租车</a></li>
		<li><a href="<?php echo WEB_PATH?>?m=create_html&a=qiugou" target="report_iframe">生成求购</a></li>
